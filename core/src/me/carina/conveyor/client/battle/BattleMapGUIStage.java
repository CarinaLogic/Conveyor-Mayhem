...
import me.carina.conveyor.client.scenes.GUIStage;
...
public class BattleMapGUIStage extends GUIStage<BattleScreen> {
    ...
    public void init(Table table) {
        ...
        table.row();
        table.add(getScreen().map.factions.getFaction("").getUnits().newDisplay(UIBattleSkillPanels.class)).top().right().expand().padRight(32);
        table.row();
